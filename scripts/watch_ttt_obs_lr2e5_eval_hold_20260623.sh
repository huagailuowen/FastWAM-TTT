...
SESSION="ttt_obs_fp32_lr2e5_const_nowarmup_resume_lowlr550_gpu01_20260623"
RUN_DIR="/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/cy/tool_adaptation_Project/TTTdynamics/repos/FastWAM/runs/ttt_dynamic_carrier_slow100_observe_ttt_2cam224_video_ttt/20260623_fp32_resume_from_lr2e4_step000550_gpu01_obs_g10_execbw_g2_b4_acc1_lr2e5_const_nowarmup_save50_log1"
TRAIN_LOG="/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/cy/tool_adaptation_Project/TTTdynamics/repos/FastWAM/logs/train/20260623_ttt_obs_fp32_resume_from_lr2e4_step000550_gpu01_b4_acc1_lr2e5_const_nowarmup_save50_log1.log"
WATCH_LOG="/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/cy/tool_adaptation_Project/TTTdynamics/repos/FastWAM/logs/train/20260623_ttt_obs_fp32_lr2e5_eval_hold_watch.log"
...
FALLBACK_STATS="/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/cy/tool_adaptation_Project/TTTdynamics/repos/FastWAM/runs/ttt_dynamic_carrier_slow100_observe_ttt_2cam224_video_ttt/20260623_fp32_from_stage1_step010000_gpu01_obs_g10_execbw_g2_b4_acc1_lr5e4_save50_log1/dataset_stats.json"
EVAL_ROOT="/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/cy/tool_adaptation_Project/TTTdynamics/repos/FastWAM/evaluate_results/dynamic_carrier/20260623_ttt_obs_fp32_lr2e5_final_in_domain_observe40_60_n20"
HOLDER_LOG="/inspire/hdd/project/robot-reasoning/xuyue-p-xuyue/cy/tool_adaptation_Project/TTTdynamics/repos/FastWAM/logs/gpu_hold/after_ttt_obs_fp32_lr2e5_eval_gpu1.log"
...
run_eval() {
  ...
  run_name="ttt_obs_fp32_lr2e5_${step}_observe40_60_execution_start"
  ...
  {
    echo "=== $(date -Is) ttt_obs_fp32_lr2e5 observe_then_act eval ==="
...
log "watcher started run=${RUN_DIR}"

while train_running || tmux has-session -t "$SESSION" 2>/dev/null; do
  step="$(latest_step)"
  ...
  tail -n 5 "$TRAIN_LOG" >> "$WATCH_LOG" 2>&1 || true
  sleep 600
done
